...
var GeminiAskTool = mcp.NewTool(
	...
	mcp.WithBoolean("enable_thinking", mcp.Description("Optional: Enable thinking mode to see model's reasoning process (Gemini 3 Pro)")),
	mcp.WithString("thinking_level", mcp.Description("Optional: Thinking level for Gemini 3 (low, high; medium coming soon). Default is 'high'")),
